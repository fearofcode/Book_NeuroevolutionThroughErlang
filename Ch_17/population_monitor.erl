...
-define(INIT_CONSTRAINTS,[#constraint{morphology=Morphology,connection_architecture=CA, population_evo_alg_f=generational,agent_encoding_types=[substrate],substrate_plasticities=[iterative],substrate_linkforms = [l2l_feedforward]} || Morphology<-[discrete_tmaze],CA<-[feedforward]]).
-record(state,{
	op_mode = gt,
	population_id = test,
