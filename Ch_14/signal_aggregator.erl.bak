...
dot_product([{IProcessID,Input}|IAcc],[{IProcessID,Weights}|IWeightedInputProcessIDs],Acc)->
...
mult_product([{IProcessID,Input}|IAcc],[{IProcessID,Weights}|IWeightedInputProcessIDs],Acc)->
