...
add_outlink(AgentID)->
	...
	case lists:append(ActuatorIDs,Outlink_NeuronIDPool) -- OutputIDs of
		[] ->
...
add_neuron(AgentID)->%Adds neuron and connects it to other neurons, not sensors or actuators.
	...
	ToElementId_Pool = Outlink_NeuronIDPool++ActuatorIDs,
	case (Inlink_NeuronIDPool == []) or (Outlink_NeuronIDPool == []) of
		true ->
