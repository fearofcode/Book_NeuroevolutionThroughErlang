...
-define(INIT_CONSTRAINTS,[#constraint{morphology=Morphology,connection_architecture=CA, population_evo_alg_f=generational,neural_pfns=[ojas_w]} || Morphology<-[discrete_tmaze],CA<-[recurrent]]).
-record(state,{
	op_mode = gt,
	population_id = test,
