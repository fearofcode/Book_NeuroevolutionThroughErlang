...
xor_mimic(sensors)->
	[
		#sensor{id={sensor,generate_id()},name=xor_GetInput,scape={private,xor_sim},vector_length=2}
	];
xor_mimic(actuators)->
	[
		#actuator{id={actuator,generate_id()},name=xor_SendOutput,scape={private,xor_sim},vector_length=1}
	].
