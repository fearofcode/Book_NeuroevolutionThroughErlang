...
-record(sensor,{id,name,type,cortex_id,scape,vector_length,fanout_ids=[],generation,format,parameters,gt_parameters,phys_rep,vis_rep,pre_f,post_f}). 
-record(actuator,{id,name,type,cortex_id,scape,vector_length,fanin_ids=[],generation,format,parameters,gt_parameters,phys_rep,vis_rep,pre_f,post_f}).
